...
class EditCustomerInfo(unittest.TestCase):
    ...
    def test_edit_customer_details(self):
        ...
        elem.click()
        time.sleep(2)
        elem = driver.find_element_by_xpath("//*[@id=\"app-layout\"]/div/div/div/div[3]/table/tbody/tr[4]/td[13]/a")
        elem.click()
        time.sleep(2)
        elem = driver.find_element_by_id("id_address")
        elem.clear()
        elem.send_keys("Dodge Street Updated")
        time.sleep(2)
        elem = driver.find_element_by_id("id_zipcode")
        elem.clear()
        elem.send_keys("68183")
        time.sleep(2)
