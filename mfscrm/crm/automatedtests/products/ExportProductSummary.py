...
class ExportProductSummary(unittest.TestCase):

    def setup(self):
        self.driver = webdriver.Chrome()

    def test_export_product_summary(self):
        user = "instructor"
        pwd = "instructor1a"
        ...
        elem.click()
        time.sleep(2)
        elem = driver.find_element_by_xpath("//*[@id=\"app-layout\"]/div/div/div/div[3]/table/tbody/tr[4]/td[10]/a")
        elem.click()
        time.sleep(2)
